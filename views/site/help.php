        ...
        <div class="container">
            ...
            <div class="help_field">
                ...
                <ol>
                    ...
                    <li>Скачать шаблон файла загрузки (кнопка "Скачать шаблон" в header);</li>
                    ...
                    <li>После загрузки файла отобразятся диаграммы (При наведении курсора на сектор диаграммы отображается окно со "Способом закупки" и "Количеством договоров");</li>
                    <li>Для получения детальной информации необходимо нажать на кнопку "Раскрыть БДР/ИП" (кнопки под диаграммами);</li>
                    <li>Для скрытия поткрывшегося окна с таблицей необходимо нажать на кнопку "Скрыть БДР/ИП" (кнопки под диаграммами);</li>
                </ol>
